...
console.log(fruits[5]); //There's no at items 5 Now a Internationally make a mistake beacause Arrays are zero index ((our array only has 4 items).
console.log(fruits[4]); // I choose a valid index.
